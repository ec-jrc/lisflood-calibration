...
resultsstep2 = pandas.read_csv("<PATH>/PARAM_TRANSFER_GloFASv5_headcatchments/IDs_closest_noLakes_noRes_minKGE041_corrections.csv", sep=",", index_col=0)  ###
targetcatchmentlist=np.array(resultsstep2['stationID'])[:]
clostesgeographycatchlist = np.array(resultsstep2['geography'])[:]

paramtransferdirectory = "<PATH>/PARAM_TRANSFER_GloFASv5_headcatchments/HEADCATCHMENTS_noLakes_noRes_minKGE041/"
interstationID_directories = np.load('<PATH>/PARAM_TRANSFER_GloFASv5_headcatchments/headcatchments_ALL_directories_nolakes_nores.npy')
...
for tc  in np.arange(startfrom,endat):
   ...
   fullpathselectedT='<PATH>/catchments/SouthAmerica/OrinocoAtlanticNorthCoast/'+ str(targetcatchmentID)###############
   ...
   parameters_source_file = pandas.read_csv("<PATH>/calibration3arcmin_workflow/catchments/v5_allresultsfromLeonardo_23dec2025/"+continent[:]+'/'+basin[:]+'/'+str(clostesgeographycatchID)+'/pHistoryWRanks.csv')
   parameters_source_folder = "<PATH>/calibration3arcmin_workflow/catchments/v5_allresultsfromLeonardo_23dec2025/"+continent[:]+'/'+basin[:]+'/'+str(clostesgeographycatchID)
   ...
   source_dir_target_calibrated = "<PATH>/calibration3arcmin_workflow/catchments/v5_allresultsfromLeonardo_23dec2025/"+continentT[:]+'/'+basinT[:]+'/'+str(targetcatchmentID)+'/out' 
   ...
   shutil.copy("<PATH>/PARAM_TRANSFER_GloFASv5_headcatchments/OSLisfloodGloFASv5calibration_v1_template_PreRunlong_term_run.xml",settings_dir)
   shutil.copy("<PATH>/PARAM_TRANSFER_GloFASv5_headcatchments/OSLisfloodGloFASv5calibration_v1_template_Runlong_term_run.xml",settings_dir)
   ...
   subprocess.run([sys.executable, "<PATH>/LFbranchfeatureinit/GitHub_development_27dec2025/lisflood-code/src/lisf1.py",prerun_file ]) 
   ...
   #lisf1.main(run_file)  
   subprocess.run([sys.executable, "<PATH>/LFbranchfeatureinit/GitHub_development_27dec2025/lisflood-code/src/lisf1.py",run_file ]) 
