...
def cut_maps_station(cfg, path_maps, stations_data, obsid):
    ...
    with dask.config.set({'scheduler': 'threads', 'array.chunk-size': '2048MiB', 'pool': ThreadPool(2)}):  # [distributed, multiprocessing, processes, single-threaded, sync, synchronous, threading, threads]
