...
def cut_maps_station(cfg, path_maps, stations_data, obsid):
    ...
    with dask.config.set({'scheduleri': 'threads', 'array.chunk-size': '2048MiB'}):  # [distributed, multiprocessing, processes, single-threaded, sync, synchronous, threading, threads]
