...
def extract_station_data(cfg, obsid, station_data, check_obs=True, model=None):
    """
    ...
    if model is not None:
        valid_start, valid_end = reservoirs.find_valid_period(model, dt, observations_filtered, valid_start, valid_end, min_years=4)
